pub const TAGS: &[&str] = &[
    ...
    "asuna_(bunny_girl)_(blue_archive)",
    ...
    "shiroko_(terror)_(blue_archive)",
    "hasumi_(swimsuit)_(blue_archive)",
    "saki_(blue_archive)",
    "female_sensei_(blue_archive)",
    "mutsuki_(blue_archive)",
    "shiroko_(swimsuit)_(blue_archive)",
    "yuuka_(gym_uniform)_(blue_archive)",
    "arona's_sensei_doodle_(blue_archive)",
    ...
    "karin_(bunny_girl)_(blue_archive)",
