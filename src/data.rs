...
pub const REGISTRY: &[Anime] = &[
    ...
    Anime { id: "data_gif", title: "GIF SFW Tags", provider: "others", tags: TagData::Gif(data_gif::DATAGIF) },
    Anime { id: "data_gif_nsfw", title: "GIF NSFW Tags", provider: "others", tags: TagData::Gif(data_gif_nsfw::DATAGIFNSFW) },
